...
% TODO -- include why we need a pivot class for the unregularized model and why we don't for the regularized one
...
% TODO
% You are on page 26 of the lecture notes and page 167 of the textbook
